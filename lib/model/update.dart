...
class _AddUserState extends State<AddUser> {
  ...
  @override
  void initState() {
    correlationController.text = widget.todo.contactNum;
    nameController.text = widget.todo.name;
    ageController.text = widget.todo.age;
    birthdateController.text = widget.todo.birthdate;
    contactNumController.text = widget.todo.contactNum;
    addressController.text = widget.todo.address;
    super.initState();
  }
